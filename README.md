...
There is no simulator build. All teams use the same sequence. Existing explicit choices are reused. Follow the facilitator's schedule rather than a promised generation time.
...
Publish only Public. Presenter contains facilitation notes. Save generated artifacts separately. Legacy presenter slides may still show an older sequence; the current guide and these launch prompts govern this version.
